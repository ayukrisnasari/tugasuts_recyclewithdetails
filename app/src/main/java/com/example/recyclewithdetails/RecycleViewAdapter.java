...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int i) {
        ...
        holder.btnFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG,"onClick: clicked on: "+ mountImages.get(i));
                Toast.makeText(mContext, "anda menyukasi "+mountNames.get(i),Toast.LENGTH_SHORT).show();
            }
        });
        holder.btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(TAG,"onClick: clicked on: "+ mountImages.get(i));
                Toast.makeText(mContext, "Anda membagikan "+ mountNames.get(i),Toast.LENGTH_SHORT).show();
            }
        });
